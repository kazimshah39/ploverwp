...
function ploverwp_front_end_scripts() {
  ...
  wp_enqueue_style('ploverwp-tailwind-css', get_theme_file_uri('/assets/css/dist/tailwind.css'), [], microtime());
  wp_enqueue_style('ploverwp-main-css', get_theme_file_uri('/assets/css/dist/main.css'), [], microtime());
